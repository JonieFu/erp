<template>
  <div class="container">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>光电耦合器</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card
    ...
    >
      <div class="el-dialog-div">
        <el-form ref="rawform" :model="addlibraryForm" label-width="130px">
          <el-form-item label="光电耦合器ID" prop="gdohqid"
            ><el-input
              v-model="addlibraryForm.gdohqid"
              placeholder=""
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="传输比实测值(%)" prop="csbscz"
            ><el-input
              v-model="addlibraryForm.csbscz"
              placeholder=""
            ></el-input>
          </el-form-item>
          <el-form-item label="光电耦合测试结论" prop="gdohcsjl"
            ><el-input
              v-model="addlibraryForm.gdohcsjl"
              placeholder=""
            ></el-input>
          </el-form-item>
        </el-form>
