  ...
  <div class="container">
    ...
    <el-card
      ><el-form ref="libraryForm" :model="SearchForm" size="small">
        <el-row :gutter="10">
          <el-col :span="4"
            ><el-form-item label="压敏电阻ID" label-width="90px" prop="ymdzid"
              ><el-input v-model="SearchForm.ymdzid"></el-input></el-form-item
          ></el-col>
          <el-col :span="4"
            ><el-form-item
              label="生产订单编号"
    ...
    >
      <div class="el-dialog-div">
        <el-form ref="rawform" :model="addlibraryForm" label-width="130px">
          <el-form-item label="压敏电阻ID" prop="ymdzid"
            ><el-input
              v-model="addlibraryForm.ymdzid"
              placeholder=""
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="压敏电压实测值" prop="ymdyscz"
            ><el-input
              v-model="addlibraryForm.ymdyscz"
              placeholder=""
            ></el-input>
          </el-form-item>

          <el-form-item label="压敏电阻测试结论" prop="ymdzcsjl"
            ><el-input
              v-model="addlibraryForm.ymdzcsjl"
              placeholder=""
            ></el-input>
          </el-form-item>
        </el-form>
