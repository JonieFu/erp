<template>
  <div class="container">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>电池</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card
      ><el-form ref="libraryForm" :model="SearchForm" size="small">
        <el-row :gutter="10">
          <el-col :span="4"
            ><el-form-item label="电池ID" label-width="100px" prop="dcid"
    ...
    >
      <div class="el-dialog-div">
        <el-form ref="rawform" :model="addlibraryForm" label-width="140px">
          <el-form-item label="电池ID" prop="dcid"
            ><el-input v-model="addlibraryForm.dcid" placeholder=""></el-input>
          </el-form-item>
          ...
          <el-form-item label="电压值(V)" prop="dyz"
            ><el-input v-model="addlibraryForm.dyz" placeholder=""></el-input>
          </el-form-item>
          <el-form-item label="电池检测结论" prop="dcjcjl"
            ><el-input
              v-model="addlibraryForm.dcjcjl"
              placeholder=""
            ></el-input>
          </el-form-item>
        </el-form>
