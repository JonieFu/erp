<template>
  <div class="container">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>晶体谐振合器</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card
    ...
    >
      <div class="el-dialog-div">
        <el-form ref="rawform" :model="addlibraryForm" label-width="140px">
          <el-form-item label="晶体谐振器ID" prop="jtxzqid"
            ><el-input
              v-model="addlibraryForm.jtxzqid"
              placeholder=""
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="频差实测值(PPM)" prop="pcscz"
            ><el-input v-model="addlibraryForm.pcscz" placeholder=""></el-input>
          </el-form-item>
          <el-form-item label="晶体谐振器检测结论" prop="jtxzqjcjl"
            ><el-input
              v-model="addlibraryForm.jtxzqjcjl"
              placeholder=""
            ></el-input>
          </el-form-item>
        </el-form>
