<template>
  <div class="container">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>液晶</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card
      ><el-form ref="libraryForm" :model="SearchForm" size="small">
        <el-row :gutter="10">
          <el-col :span="4"
            ><el-form-item label="液晶ID" label-width="60px" prop="yjid"
              ><el-input v-model="SearchForm.yjid"></el-input></el-form-item
          ></el-col>
          <el-col :span="4"
            ><el-form-item
              label="生产订单编号"
    ...
    >
      <div class="el-dialog-div">
        <el-form ref="rawform" :model="addlibraryForm" label-width="140px">
          <el-form-item label="液晶ID" prop="yjid"
            ><el-input v-model="addlibraryForm.yjid" placeholder=""></el-input>
          </el-form-item>
          ...
          <el-form-item label="显示结论" prop="xsjl"
            ><el-input v-model="addlibraryForm.xsjl" placeholder=""></el-input>
          </el-form-item>
        </el-form>
      </div>
