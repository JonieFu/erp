<template>
  <div class="container">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>电流互感器</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card
      ><el-form ref="libraryForm" :model="SearchForm" size="small">
        <el-row :gutter="10">
          <el-col :span="4"
            ><el-form-item label="电流互感器ID" label-width="100px" prop="dcid"
    ...
    >
      <div class="el-dialog-div">
        <el-form ref="rawform" :model="addlibraryForm" label-width="140px">
          <el-form-item label="电流互感器ID" prop="dlhgqid"
            ><el-input
              v-model="addlibraryForm.dlhgqid"
              placeholder=""
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="比差值(%)" prop="bcz"
            ><el-input v-model="addlibraryForm.bcz" placeholder=""></el-input>
          </el-form-item>
          <el-form-item label="电流互感器检测结论" prop="dlhgqjcjl"
            ><el-input
              v-model="addlibraryForm.dlhgqjcjl"
              placeholder=""
            ></el-input>
          </el-form-item>
        </el-form>
